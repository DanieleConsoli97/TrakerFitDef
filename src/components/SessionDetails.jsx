        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="space-y-3">
            ...
            <select 
              ...
              defaultValue=""
            >
              <option value="" disabled className="bg-violet-800 dark:bg-violet-800 light:bg-gray-100 text-violet-300 dark:text-violet-300 light:text-gray-500">
                Scegli un esercizio...
              </option>
              {exercisesIndex?.exercises.map((e) => (
                <option key={e.id} value={e.id} className="bg-violet-800 dark:bg-violet-800 light:bg-white text-white dark:text-white light:text-gray-900 py-2">
                  {e.nome}
                </option>
              ))}
            </select>
          ...
          <Button 
            className="group relative overflow-hidden w-full 
                       ...
                       active:scale-95 border-0 text-sm sm:text-base lg:text-lg"
